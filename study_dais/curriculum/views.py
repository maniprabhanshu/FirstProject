...
class LessonDetailView(DetailView,FormView):
    ...
    # send two forms two the page and check which one is posted. Take action on the form which is posted
...
class LessonCreatedView(CreateView):
...
class LessonUpdateView(UpdateView):
    ...
    content_object_name='lessons'
    # def get_success_url(self):
    #     standard=self.object.Standard
    #     subject= self.object.subject
    #     lesson=self.object.lesson
    #     return reverse_lazy('curriculum:lesson_detail', kwargs={'standard':standard.slug,'subject':subject.slug,'slug':lesson.slug})
class LessonDeleteView(DeleteView):
    ...
    def get_success_url(self):
        standard=self.object.Standard
        subject= self.object.subject
        return reverse_lazy('curriculum:lesson_delete', kwargs={'standard':standard.slug,'slug':subject.slug})
